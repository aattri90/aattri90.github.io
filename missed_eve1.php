	...
	<div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNavBar">
              <ul class="nav navbar-nav ">
                ...
                <li><a href="index.html#societies">SOCIETIES</a></li>
                <li class= "active_opt"><a id="yes" href="#myPage">EVENTS</a></li>
...
<div class="container text-center">
  <h1><u>THAPAR UNIVERSITY MISSED EVENTS</u></h1>
  <br>
<div class="row">
    <div class="col-sm-4">
      <div class="panel panel-default text-center">
                    ...
                    <h1>URJA 2k15</h1>
                          ...
                          <div>
                          <a href="http://urja2015.com/"><img src="urjalogo.jpg" alt="TUSOC" class="img-responsive"></a>
                          </div>
                    <div class="panel-footer plan">
                    <button class="btn btn-lg" onclick="location.href='http://urja2015.com/'">Visit website</button>
                    </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-default text-center">
                    <div class="panel-heading">
                    <h1>Saturnalia 2k15</h1>
                    </div>
                          <div>
                          <a href="http://saturnaliathapar.com/"><img src="saturnalia.jpg" alt="TUSOC" class="img-responsive"></a>
                          </div>
                    <div class="panel-footer plan">
                    <button class="btn btn-lg" onclick="location.href='http://saturnaliathapar.com/'">Visit website</button>
                    </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-default text-center">
                    ...
                    <h1>Aranya 2k14</h1>
                          ...
                          <div>
                          <a href="http://aranyatu.co.in/"><img src="aranya.jpg" alt="Aranya" class="img-responsive"></a>
                          </div>
                    <div class="panel-footer plan">
                    <button class="btn btn-lg" onclick="location.href='http://aranyatu.co.in/'">Visit website</button>
                    </div>
      </div>
    </div>
  </div>
