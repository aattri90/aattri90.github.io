...
<div class="container main"><br><br>
    <h1><u>NSS National Social Services</u> :</b></h1>
    <table>
		<tr>
			<td>
				National Service scheme is a society of Thapar university which 
				organizes activities <br>for the welfare of society and celebrates
				the days of national importance.
			</td>
			<td id="image_col">
				<img style="margin-left:95px;" src="nss.jpeg" width="200" height="160" align="right">
			</td>
		</tr>
	</table><br><br><br><br>
